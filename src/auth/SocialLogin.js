    ...
    return (
        <div>
            <div className='grid md:grid-cols-3 gap-2'>
                <button aria-label="Continue with google" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-2 border rounded-lg border-gray-700 flex items-center mt-4">
                ...
                <button disabled aria-label="Continue with github" className="cursor-pointer focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-2 border rounded-lg border-gray-700 flex items-center mt-4">
                ...
                <button  disabled aria-label="Continue with twitter" className="cursor-pointer focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-2 border rounded-lg border-gray-700 flex items-center mt-4">
